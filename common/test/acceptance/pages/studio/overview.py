...
class CourseOutlinePage(CoursePage, CourseOutlineContainer):
    ...
    def make_exam_proctored(self):
        ...
        self.course_outline.q(css="#id_exam_proctoring").first.click()
    ...
    def proctoring_items_are_displayed(self):
        ...
        if not self.course_outline.q(css="#id_timed_examination").present:
            return False

        # The time limit field
        if not self.course_outline.q(css="#id_time_limit").present:
            return False

        # The Practice exam checkbox
        if not self.course_outline.q(css="#id_practice_exam").present:
            return False

        # The Proctored exam checkbox
        if not self.course_outline.q(css="#id_exam_proctoring").present:
            return False
